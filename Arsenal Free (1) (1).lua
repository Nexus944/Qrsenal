...
CoreGui:SetCore("SendNotification", {
    Title = "VantaX Arsenal",
    Text = "Working For Mobile and PC Executor",
    Duration = 8,
})
CoreGui:SetCore("SendNotification", {
    Title = "Join our Discord!",
    Text = "discord.gg/XjKUB2GyqB",
    Duration = 12,
})
...
local Window     = Library.CreateLib("VantaX | Arsenal Free", "DarkTheme")

local Welcome     = Window:NewTab("Main")
local MainSection = Welcome:NewSection("Welcome To VantaX Free | " .. game.Players.LocalPlayer.Name)
MainSection:NewLabel("Want Premium with more features like AimBot?")
MainSection:NewLabel("Buy Premium on Discord: https://discord.gg/XjKUB2GyqB")
MainSection:NewLabel("Premium includes: AimBot, Silent Aim, Fly, Hitbox, and more!")
...
PlayerSection:NewLabel("Premium Only - Buy on Discord: https://discord.gg/XjKUB2GyqB")
...
frame.ImageColor3 = Color3.fromRGB(0, 0, 0) -- Schwarz
...
button.Text = "Toggle"
button.TextColor3 = Color3.fromRGB(0, 0, 0) -- Schwarz
button.TextSize = 20
